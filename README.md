...
**Requisito Obrigatório** é ter node instalado.

Primeiro passo é ligarmos o servidor, para isso podemos fazer de duas formas:
1ª - Tendo yarn e nodemon instalados na máquina, utilizaremos o comando **yarn dev** no terminal.
2ª - Iniciando o terminal e digitando apenas o comando **node index**.

Logo após iniciarmos nosso servidor, podemos acessar nossa aplicação através do link <http://localhost:5000/>.
No campo **Onde iremos caçar?**, digite a cidade onde deseja fazer a consulta, clique no pokemon Unown (lupa) ou de enter e aguarde o resultado.

## Tecnologias utilizadas

Para a execução do desfio, foram utilizadas as seguintes tecnologias:
